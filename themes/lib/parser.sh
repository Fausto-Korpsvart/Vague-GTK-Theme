...
OPTIONS:
  ...
  -a, --accent VARIANT    Specify theme accent variant(s) [default|blue|green|grey|orange|pink|purple|red|teal|yellow|all] (Default: accent)
  ...
  --tweaks                Specify versions for GTK application tweaks:
                           1. [medium|soft] Colour scheme versions
    ...
    while [[ $# -gt 0 ]]; do
        case "${1}" in
            ...
            -a | --accent)
                ...
                for variant in "$@"; do
                    case "$variant" in
                        ...
                        green)   themes+=("${THEME_VARIANTS[2]}"); shift ;;
                        grey)    themes+=("${THEME_VARIANTS[3]}"); shift ;;
                        orange)  themes+=("${THEME_VARIANTS[4]}"); shift ;;
                        pink)    themes+=("${THEME_VARIANTS[5]}"); shift ;;
                        purple)  themes+=("${THEME_VARIANTS[6]}"); shift ;;
                        red)     themes+=("${THEME_VARIANTS[7]}"); shift ;;
                        teal)    themes+=("${THEME_VARIANTS[8]}"); shift ;;
                        yellow)  themes+=("${THEME_VARIANTS[9]}"); shift ;;
            ...
            --tweaks)
                ...
                while [[ $# -gt 0 ]]; do
                    case "${1}" in
                        medium)  medium="true";    ctype="-Medium"; shift ;;
                        soft)    soft="true";      ctype="-Soft";   shift ;;
