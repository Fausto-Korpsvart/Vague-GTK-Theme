...
THEME_VARIANTS=('' '-Blue' '-Green' '-Grey' '-Orange' '-Pink' '-Purple' '-Red' '-Teal' '-Yellow')
...
medium="false"          # Intermediate grey background scheme
soft="false"            # Warmer grey background scheme
