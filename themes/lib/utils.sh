...
LOG_FILE="${HOME}/.cache/vague-install.log"
CMD_LOG="/tmp/vague_cmd.log"
...
# Prints the Vague GTK Theme installer banner.
print_banner() {
    clear 2>/dev/null || true
    printf "\n"
    printf "${COLOR_VIOLET}V A G U E   G T K   T H E M E${COLOR_RESET}\n"
...
print_summary() {
    ...
    local theme_val="Dark"; local theme_label=" (Default)"
    [[ "$medium"    == "true" ]] && { theme_val="Medium";    theme_label=""; }
    [[ "$soft"      == "true" ]] && { theme_val="Soft";      theme_label=""; }
    ...
    printf "│\n"
    printf "└ ${COLOR_SUCCESS}󰅏 ENJOY VAGUE THEME!${COLOR_RESET}\n"
}
